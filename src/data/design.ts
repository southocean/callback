...
export const feedback: Section = {
  ...
  rules: [
    ...
    { name: 'Focus (visible)', value: '12% state layer, plus the ring below', note: 'Keyboard focus must be louder than hover, never quieter — so the layer goes past hover’s .08, and the ring does the rest.' },
