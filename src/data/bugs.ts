...
export interface Bug {
  ...
  palette: Palette;
  /**
   * How to find it. Shown on the silhouette too, because a collection nobody
   * can finish is a list of things they failed at.
   */
  hint: string;
...
export const bugs: Bug[] = [
  {
    ...
    hint: 'Raise your hand until somebody objects.',
  ...
  },
  {
    ...
    hint: 'Keep pressing the thing that is a picture of wifi.',
  ...
  },
  {
    ...
    hint: 'React. Then react again. Then again.',
  ...
  },
  {
    ...
    hint: 'Turn the shared computer off. Properly off.',
  ...
  },
  {
    ...
    hint: 'Turn the captions off and on until somebody notices.',
  ...
  },
  {
    ...
    hint: 'Send a window to the taskbar, and keep doing it.',
  ...
  },
  {
    ...
    hint: 'Resize a window. Then resize it again. And again.',
  ...
  },
  {
    ...
    hint: 'Close things. Three of them.',
  ...
  },
  {
    ...
    hint: 'Move the windows around. Yes, you can do that.',
  ...
  },
  {
    ...
    hint: 'The camera control does nothing. Do it anyway, three times.',
  ...
  },
  {
    ...
    hint: 'That clock is the only honest thing on this desktop. Ask it three times.',
  ...
  },
  {
    ...
    hint: 'A browser inside a browser. Open three more tabs in it.',
